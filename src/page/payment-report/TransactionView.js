...
import LogoDark1 from "../../images/logo1.png";
        ...
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle>
                Invoice{" "}
                <strong className="text-primary small"> # {cdata !== null ? cdata.transaction_id : "0"} </strong>
              </BlockTitle>
                ...
                <ul className="list-inline">
                  <li>
                    ...
                    <span className="text-base">
                      {" "}
                      <Moment format="DD-MM-YYYY HH:mm:ss A">{cdata !== null ? cdata.created_at : "0"}</Moment>{" "}
                    </span>
                  </li>
                </ul>
              </BlockDes>
