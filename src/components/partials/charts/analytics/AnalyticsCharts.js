...
export const SessionDoughnut = ({ state, state1, state3, className }) => {
 // console.log(state);
// console.log(state1);
  const data = {
...
export const SessionDoughnutOs = ({ state, state1, state3, className }) => {
  // console.log(state);
 // console.log(state1);
   const data = {
     labels: ["Window", "Apple", "Android"],
     dataUnit: "People",
     legend: false,
     datasets: [
       {
 ...
 export const TCDoughnutAds = ({ state, className }) => {
  // console.log(state);
 // console.log(state1);
   const data = {
     labels: ["Text Ad", "Banner Ad", "Social Ad", "Native Ad", "Video Ad", "Popunder Ad"],
     dataUnit: "People",
     legend: false,
     datasets: [
       {
         borderColor: "#fff",
         backgroundColor: ["#798bff", "#b8acff", "#ffa9ce", "#f9db7b", "#EA4335", "#34A853"],
         data: [ state.textper, state.bannerper, state.socialper, state.nativeper, state.videoper, state.popupper],
       },
     ],
   };
   return (
